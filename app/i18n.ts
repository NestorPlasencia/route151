...
const TEXT = {
 ...
 trainingSpecies: ['Species: {n} (main attack stat: {stat})', 'Especie: {n} (ataque principal: {stat})'],
 trainingIvs: ['Its IVs: {n}', 'Sus IVs: {n}'],
 trainingIvsAssumed: ['IVs: assumed average; type in its stats to count them', 'IVs: se suponen normales; escribe sus estadísticas para contarlos'],
 trainingNature: ['Its nature: {n}', 'Su naturaleza: {n}'],
 train1: ['Weak', 'Flojo'],
