...
const TEXT = {
 ...
 hitsFor: ['{n}% to an average target', '{n}% a un rival medio'],
 dropThis: ['Replace {move}: it is the weakest.', 'Cambia {move}: es el más flojo.'],
 keepMoves: ['Keep your moves: {move} hits for less.', 'Quédate como estás: {move} pega menos.'],
 dropYouDecide: ['It does no damage: keep it only for what it does.', 'No hace daño: consérvalo solo por su efecto.'],
 compareNote: ['Damage worked out with the stats of this Pokémon against an average target, counting accuracy. It does not weigh types or effects.', 'Daño calculado con las estadísticas de este Pokémon contra un rival medio, contando la precisión. No tiene en cuenta tipos ni efectos.'],
