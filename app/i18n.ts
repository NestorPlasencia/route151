...
const TEXT = {
 ...
 effectRaise: ['Raises {stat}', 'Sube {stat}'],
 effectRaiseMuch: ['Sharply raises {stat}', 'Sube mucho {stat}'],
 effectLower: ['Lowers {stat}', 'Baja {stat}'],
 effectLowerMuch: ['Sharply lowers {stat}', 'Baja mucho {stat}'],
 ...
 bestPartyHit: ['Best at Lv. {level}: {pokemon} · {move} — {min}–{max}%', 'Mejor a Nv. {level}: {pokemon} · {move} — {min}–{max}%'],
