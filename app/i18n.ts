...
const TEXT = {
 ...
 out: ['Fainted', 'Debilitado'],
 outMark: ['Mark as fainted', 'Marcar como debilitado'],
 ...
 evolveHow: ['when it evolves', 'al evolucionar'],
 canEvolve: ['ready to evolve', 'le toca evolucionar'],
 evolveNote: ['It keeps its level, its nature and its moves. The stats you wrote are cleared: the base stats change, so they are estimated again until you read the card.', 'Conserva el nivel, la naturaleza y los ataques. Las estadísticas que escribiste se borran: las bases cambian, así que vuelven a estimarse hasta que leas la ficha.'],
 ...
 movesCount: ['{n} moves', '{n} ataques'],
 movesCountOne: ['1 move', '1 ataque'],
 movesNone: ['no moves yet', 'sin ataques'],
 quickAdd: ['One tap and it is in your team: the level comes from how far you are in the checklist, and the moves are the ones it learns by then. Change only what you care about.', 'Un toque y está en tu equipo: el nivel sale de por dónde vas en la lista y los ataques son los que aprende hasta ahí. Cambia solo lo que te importe.'],
 scan: ['Read a card with the camera', 'Leer una ficha con la cámara'],
 scanCardHelp: ['Photograph the Skills, Info and Known Moves screens of your {pokemon} and its data is filled in. One at a time is fine: each photo adds to the one before.', 'Fotografía las pantallas Datos, Información y Movimientos de tu {pokemon} y se rellenan sus datos. Puedes ir de una en una: cada foto se suma a la anterior.'],
 scanFill: ['Fill in this Pokémon', 'Rellenar este Pokémon'],
 scanOther: ['That card is {pokemon}, not this Pokémon: check you are filling in the right one.', 'Esa ficha es de {pokemon}, no de este Pokémon: revisa que estés rellenando el correcto.'],
 scanHelp: ['Take a photo, or pick a screenshot, of the Skills, Info and Known Moves screens. Several at once is fine.', 'Haz una foto, o escoge una captura, de las pantallas Datos, Información y Movimientos. Puedes pasar varias a la vez.'],
 scanPhoto: ['Take a photo', 'Hacer una foto'],
 scanPick: ['Choose images', 'Escoger imágenes'],
 scanReading: ['Reading image {done} of {total}…', 'Leyendo la imagen {done} de {total}…'],
 scanNothing: ['Nothing readable came out: try again with the screen filling the photo, straight on and without glare.', 'No salió nada legible: repite con la pantalla llenando la foto, de frente y sin reflejos.'],
 scanFailed: ['The reader could not start. If this is the first time, connect once so it can download.', 'No se pudo iniciar el lector. Si es la primera vez, conéctate una vez para que se descargue.'],
 scanPickSpecies: ['— choose the Pokémon —', '— escoge el Pokémon —'],
 scanLevelGuess: ['worked out from the stats: {n} levels fit', 'deducido de las estadísticas: cuadran {n} niveles'],
 scanNatureGuess: ['{n} natures fit these stats', 'hay {n} naturalezas que cuadran'],
 ...
 scanStats: ['Stats', 'Estadísticas'],
 scanMoves: ['Moves', 'Ataques'],
 scanAdd: ['Add to the team', 'Añadir al equipo'],
 scanDiscard: ['Discard', 'Descartar'],
 scanNote: ['The name and the level of the header are written with the game font and hardly ever read: the level comes from the stats and the Pokémon from its moves. Check it and correct whatever is off in its card.', 'El nombre y el nivel de la cabecera van con la tipografía del juego y casi nunca se leen: el nivel sale de las estadísticas y el Pokémon, de sus ataques. Revísalo y corrige en su ficha lo que no cuadre.'],
 scanOtherGame: ['That ability is not the one this Pokémon has in FireRed/LeafGreen: your game looks modified, so the advice may not match it.', 'Esa habilidad no es la que tiene este Pokémon en Rojo Fuego/Verde Hoja: tu juego parece modificado, así que los consejos pueden no cuadrar.'],
 ...
 battleUse: ['Use {move}', 'Usa {move}'],
 battleHit: ['{range}% of its HP', '{range}% de sus PS'],
 ...
 rankingTop: ['best {n}', 'máx. {n}'],
 rankingMine: ['In your team', 'En tu equipo'],
 rankingTrade: ['Needs a trade', 'Requiere intercambio'],
 rankingCaught: ['Caught', 'Atrapados'],
 rankingNoLegendary: ['No legendaries', 'Sin legendarios'],
 rankingNoTrade: ['No trading', 'Sin intercambio'],
 ...
 trainingFinal: ['Scored at level 100', 'Calculado a nivel 100'],
 trainingSpecies: ['Species ({name}): {n}/100, counts 60%. Its main attack stat is {stat}.', 'Especie ({name}): {n}/100, pesa 60 %. Su ataque principal es {stat}.'],
 trainingSpecimen: ['This one against others of its species: {n}/100, counts 40%', 'Este ejemplar frente a otros de su especie: {n}/100, pesa 40 %'],
 trainingIvs: ['{stat} IV about {n} of 31, Speed IV about {spe} of 31', 'IV de {stat} cerca de {n} de 31 y de Velocidad cerca de {spe} de 31'],
 trainingIvsAssumed: ['IVs assumed average: type in its stats to count them', 'IVs supuestos normales: escribe sus estadísticas para contarlos'],
 trainingNature: ['{nature}: {n} for this one', '{nature}: {n} al ejemplar'],
 trainingNatureDown: ['{nature} lowers {stat}, the stat it hits with: {n} for this one', '{nature} baja {stat}, justo con lo que pega: {n} al ejemplar'],
 trainingNatureUp: ['{nature} raises {stat}, the stat it hits with: {n} for this one', '{nature} sube {stat}, justo con lo que pega: {n} al ejemplar'],
 train1: ['Weak', 'Flojo'],
 train2: ['Average', 'Normal'],
 train3: ['Good', 'Bueno'],
 train4: ['Very good', 'Muy bueno'],
 train5: ['Excellent', 'Excelente'],
